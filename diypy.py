...
if st.sidebar.button("Recommend"):
    ...
    if len(filter_data) < 10:
        ...
        st.header(f"There are {len(filter_data)} such apartments available, here are those apartmnents and some other recommendations")
        ...
        for i, row in rec_data.iterrows():
            ...
            with col2:
                ...
                st.markdown(f"**Sqft:** {row['carpet_area_sqft']} Sqft")
